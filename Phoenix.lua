...
Phoenix.optionFireSpirit = Menu.AddOption({"Hero Specific", "Phoenix", "Auto Fire Spirit"}, "Activation", "Auto Fire Spirit before Icarus Drive or SuperNova")
Phoenix.optionCastFireSpirit = Menu.AddOption({"Hero Specific", "Phoenix", "Auto Fire Spirit"}, "Spirits before Icarus Drive", "AutoCast spirits before Icarus Drive")

Phoenix.optionSunRay = Menu.AddOption({"Hero Specific", "Phoenix", "Sun Ray Aim"}, "Sun Ray Aim", "Activation")
Phoenix.optionTargetStyle = Menu.AddOption({ "Hero Specific", "Phoenix", "Sun Ray Aim"}, "Targeting style", "ON = Free target, OFF = Locked target", "0", "1", "1")
Phoenix.optionTargetRange = Menu.AddOption({ "Hero Specific", "Phoenix", "Sun Ray Aim"}, "Radius around the cursor", "Radius", "100", "1500", "100")

Phoenix.optionFailSwitch = Menu.AddOption({"Hero Specific", "Phoenix", "FailSwitch SuperNova" }, "SuperNova", "Never ult if there is no enemy in the radius")
Phoenix.optionFailSwitchPerc = Menu.AddOption({"Hero Specific", "Phoenix", "FailSwitch SuperNova" }, "Disable when % HP threshold","Disable FailSwitch when % HP threshold", "5", "90", "5")
